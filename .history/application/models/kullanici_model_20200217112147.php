...
class kullanici_model extends CI_Model
{
    ...
    public function cevapsayi()
    {
        ...
        */
        ...
        $this->db->select ["* , ('SELECT COUNT(*) from cevap cc where s.id=cc.soru_id') as cevapsayi s,
        ('SELECT cevaplama_zamanı from cevap ct where s.id=ct.soru_id order cevaplama_zamanı DESC Limit 1') as soncevap"];
        $this->db->from('soru sc');
