...
<body>
	...
	<div style="margin-left: 350px;" class="container mt-3">
		...
		<div id="p" class="easyui-panel" title="Panel" style="width:1300px;height:800px;padding:10px;background:#fafafa;" data-options="iconCls:'icon-save',closable:true,
			...
			<div title="Sorular" id="sorular" data-options="closable:true" style="overflow:auto;padding:20px;display:none;">
					...
					$.ajax({
						...
						success: function(gelenveri) {
							if (gelenveri.success) {
								...
								var p = $('#sorular').tabs('getTab', $('#sorular').tabs('getTabIndex', $('#sorular').tabs('getSelected'))) // get the first tab panel
								p.panel('refresh');
							} else {
