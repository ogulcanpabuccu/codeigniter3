	<div class="container">
		...
		foreach ($cevaplar as $cevap ) { ?>
			 ...
			 <input type="text" value="<?php echo $cevap->cevaplayan_mail ?>">
			 <input type="text" value="<?php echo $cevap->cevaplama_zamanı ?>" >
			 <textarea type="text"><?php echo $cevap->cevap_detay ?></textarea>
			 </div>
