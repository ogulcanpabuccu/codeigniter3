...
<body>
	...
	<label>Konu</label><input class="easyui-textbox" data-options="iconCls:'icon-search'" style="width:300px" value="<?php echo $sorudetay->konu ?>">
	<label>Soru Detay</label><input class="easyui-textbox" data-options="iconCls:'icon-search'" style="width:300px" value="<?php echo $sorudetay->detay ?>">
