			...
			<div title="Soru Sor" selected ; data-options="closable:true" style="overflow:auto;padding:20px;display:none;">
				...
				<form action="" method="POST"  onsubmit="return false;" id="FormID1" >
					...
					<div class="col-md-12">
						...
						<label>Alıcı Seç : </label> <select id="cc" class="easyui-combobox"  style="width:100px;">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<label>Önem Durumu :</label> <select id="cc" class="easyui-combobox" style="width:100px;">
