	...
	public function giris()
	{
		...
		if ($_POST) {
			...
			if (count($kullanici) > 0) {
				...
				$sessionData = array('kullanici_id' => $kullanici[0]->kullanici_id, 'kullanici_mail' => $kullanici[0]->kullanici_mail, 'sifre' => $kullanici[0]->kullanici_password,'kullanici_adsoyad'=>$kullanici[0]->kullanici_adsoyad);
