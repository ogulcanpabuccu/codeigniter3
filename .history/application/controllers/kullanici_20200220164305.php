...
class Kullanici extends CI_Controller
{
	...
	public function sorugonder()
	{
		...
		$session['sessionid'] = $this->session->get_userdata()['kullanici_id'];
		$session['departman'] = $this->session->get_userdata()['departman'];
		$cevap = $this->kullanici_model->cevapsayi($session);
